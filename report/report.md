...
Сетевые приложения реализуются согласно клиент-серверной архитектуре. Клиент и сервер - это программы, выступающие в разных ролях. Сервер обычно прослушивает поступающие данные и обрабатывает их, а клиент является инициатором передачи.
