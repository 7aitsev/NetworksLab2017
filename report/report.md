...
![Скриншот Wireshark с UDP траффиком, в котором получаемые пакеты дублируются](res/udp_duplicate.png)
...
```
Ошибке "An existing connection was forcibly closed by the remote host" соответствует код WSAECONNRESET. Исправления можно посмотреть в коммите e054cdffe3eb9c042d951f30061e440d1d8fff3d. [Дамп](res/udp_duplicate_windows.pcapng) также доступен.
