...
Данный способ реализации параллельной обработки соединений хорош своей простотой реализации и эффективностью обслуживания, пока число клиентов не велико. Порождение новых потоков - довольно затратная операция. Данная проблема решалась бы созданием пула потоков, если бы на практике число соединений не исчислялось тысячами. Держать десятки потоков - расточительство.
